...
- Netlib LAPACK on Linux and other Unix-like systems;
- Intel oneMKL, linked statically in sequential LP64 mode, on Windows.

The Windows backend is distributed under the
